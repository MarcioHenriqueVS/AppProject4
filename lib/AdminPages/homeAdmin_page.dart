...
import '../Desafios/criarDesafio_page.dart';
import '../Publicacoes/criarTopico_page.dart';
import '../Publicacoes/topicosList_page.dart';
import '../TeleAtendimento/join_call_page.dart';
import '../Videos/criarTemaVideos.dart';
import '../Videos/temasVideosList_page.dart';

class HomeAdminPage extends StatefulWidget {
  final String? profileImageUrl;
  const HomeAdminPage({Key? key, this.profileImageUrl}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        titleTextStyle: (const TextStyle(fontSize: 21, color: Colors.white)),
        centerTitle: true,
      ),
      drawer: Drawer(
        child: ListView(
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                  onPressed: () {
                    Navigator.push((context),
                        MaterialPageRoute(builder: (context) => CriarDesafio()));
                  },
                  child: const Text('Criar desafio')),
              ElevatedButton(
                  onPressed: () {
                    Navigator.push((context),
                        MaterialPageRoute(builder: (context) => CriarTopico()));
                  },
                  child: const Text('Criar topico')),
              ElevatedButton(
                  onPressed: () {
                    Navigator.push((context),
                        MaterialPageRoute(builder: (context) => CriarTema()));
                  },
                  child: const Text('Criar tema para vídeos')),
            ],
          ),
        ),
      ),
